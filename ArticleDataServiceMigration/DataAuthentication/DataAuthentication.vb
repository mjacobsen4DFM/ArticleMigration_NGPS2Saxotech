...
Public Class DataAuthentication
    ...
    Public Shared Function DoesSaxoAssetExist(ByVal destination_siteid As String, ByVal asset_uid As String) As Boolean
        Dim ds As DataSet = GetDataSet(String.Format("Select count(*) from saxo_image where asset_uid = '{0}' and destination_siteid ='{1}'", asset_uid, destination_siteid))
    ...
    Public Shared Function DoesArticleExist(ByVal article_uid As String) As Boolean
        Dim ds As DataSet = GetDataSet(String.Format("Select count(*) from article where article_uid = '{0}'", article_uid))
